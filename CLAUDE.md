...
- 特商法ページ: 「合同会社グラステ」は**登記完了済み**（本番デプロイの障害だった未登記リスクは解消）。ただし「所在地」「電話番号」は本人の希望でまだプレースホルダー（「お問い合わせいただいた場合、遅滞なく開示」）のまま保留中。運営責任者名も「準備中」のまま。
  - 注意: この「開示保留」表記は本来、個人事業主向けの緩和措置（2022年の運用指針改正）。合同会社は法人登記により所在地が登記情報として既に公開されているため、この表記を使うメリットは実質ない。本人には説明済みだがこのまま保留を選択
  - グラステの定款（事業目的）はイベント・エンタメ・飲食店運営中心の文言で、yoinのようなWebプラットフォーム/コンテンツ課金事業を直接カバーする条項がない。ただし4号「電子コンテンツの企画・制作・編集・販売及び配信」と6号「ECサイトの企画・制作・運営及び管理」で実務上ぎりぎりカバーできると判断し、本人はyoinについては定款変更なしで進める方針
  - 別途検討していたAIカメラ監視サービス（ヤード/駐車場の待機時間可視化、運送・産廃業界向け）は定款に該当条項がなく変更登記が必要と判明 → 本人はこちらを見送り、yoinに集中する方針に決定（この事業計画は当面ペンディング）
